...
# from threading import Thread, enumerateq
#import serial
...
def Colorsearch(img_hsv2, lower_color, upper_color):
    global color_cnt, angle, rotated_direction, dist_to_object_z, write_stack
...
def main():
    #gpu 사용 여부 추가
    #check_gpu_usage()
    global aligned_depth_frame2 , color_image, color_image2, recs_cup_cnt, regobox_cnt, regobox_socket
